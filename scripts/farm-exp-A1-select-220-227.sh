#!/usr/bin/env bash
# Experimentation A1: SELECT-grid 220->227 KNN scoring chain.
#
...
log "=== Experimentation A1 SELECT-grid 220->227 chain started (numpy backend, 7 scoring_configs) ==="
...
log "=== Experimentation A1 SELECT-grid 220->227 chain complete: 24 cells x 7 scoring_configs scored on 220->227 ==="
