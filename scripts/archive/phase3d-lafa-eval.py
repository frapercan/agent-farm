...
Inputs:
  - boosters at ~/Thesis2/repositories/protea-reranker-lab/runs/phase3d_K{k}_{plm}/
...
Outputs under /home/frapercan/Thesis2/agent-farm/results/phase3d_lafa_eval/:
...
RESULTS_ROOT = Path(
    "/home/frapercan/Thesis2/agent-farm/results/phase3d_lafa_eval"
)
...
def runs_dir(plm: str, k: int, cell: str, seed: int) -> Path:
    return RUNS_ROOT / f"phase3d_K{k}_{plm}" / f"{cell}_seed{seed}"
