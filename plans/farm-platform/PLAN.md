...
acceptance: |-
  ...
  Multi-seed pass (seeds 42/43/44) ships only on the per-(K, cell) champion (PLM × objective): 3 K × 9 cells = 27 champions × 2 extra seeds = 54 runs (or fewer if the same PLM+objective wins across cells)
